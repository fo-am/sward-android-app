 ...
 * Use the [IdLegumeCrescentFragment.newInstance] factory method to
...
class IdLegumeCrescentFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment IdLegumeCrescentFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            IdLegumeCrescentFragment().apply {
